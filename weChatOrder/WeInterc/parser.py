...
from .rec_messages import TextMessage, LocationMessage, ImageMessage, EventMessage
from .rec_messages import LinkMessage, VoiceMessage, UnknownMessage
from weChatOrder.WeInterc.utils import to_unicode
